...
<title><fmt:message key="title.setuppd" /></title>
</head>
<body>
	<form action="${pageContext.request.contextPath}/nocturne/enterrp" method=post>
		<center>
			<table cellpadding=4 cellspacing=2 border=0>
				<tr>
					<th width="30%"><fmt:message key="label.crudpd.name" /></th>
					<th width="45%"><fmt:message key="label.crudpd.address" /></th>
					<th width="25%"><fmt:message key="label.crudpd.datejoin" /></th>
				</tr>
				<tr>
					<td><fmt:message key="label.crudpd.name" /></td>
				...
				<tr>
					<td><fmt:message key="label.crudpd.address" /></td>
					<td><input type="text" name="address"
						value="${param['description']}" size=45 maxlength=20></td>
				</tr>
				<tr>
					<td><fmt:message key="label.crudpd.datejoin" /></td>
